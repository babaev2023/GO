...
func main() {
	...
	myDecimalByteSlice := []byte{100, 101, 102, 103} // Можно использовать десятичное представление байтов
	...
	// Руны как литералы
	runeLiteralSlice := []rune{'S', 't', 'e', 'p', 'a', 'n'} // '' - таким образом обозначается руна
